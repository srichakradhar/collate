...
const Dashboard = () => (
  <div className="p-4 space-y-4">
    <img src="https://t3.ftcdn.net/jpg/03/24/58/44/240_F_324584485_qtdluDzmBNkJvmntEPlNeG1htwPktgCa.jpg" width="50px" style={{float: "left"}}/>
    <h1 className="text-2xl font-bold">Collate</h1>
    <h3 className="text-2xl font-bold mb-4">Weekly Blood Pressure and Heart Rate Dashboard</h3>
